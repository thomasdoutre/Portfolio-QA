...
public class Recuit extends JFrame
{
	 ...
	 * @param p
	 * Probléme construit par l'utilisateur
	 * @param m
	 * Une mutation aléatoire correspondant au probléme traité.
	 ...
	 * Nombre d'iterations pour chaque réplique. Le nombre de répliques, on le rappelle, est défini dans Probléme.
	 * @param seed
