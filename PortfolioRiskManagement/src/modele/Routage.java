...
public class Routage extends Etat {
	...
	//Cette fonction met é jour la matrice d'Ising en connectant les noeuds i et j. Condition : i != j
	...
	//Mise é jour de la matrice d'Ising et renvoi de cette matrice
	public int[][] updateIsing(){
		...
		//On passe é 1 les noeuds lies entre eux
		for(int i =0; i<n;i++){
			now= r.get(i);
	...
	//Affiche le pourcentage de similarite entre 2 routes. Si on renvoie 100, elles sont complétement similaires. Si on renvoie 0, elles sont complétement differentes.
