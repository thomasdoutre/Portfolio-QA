...
/**
 * Calcule les sommes de produits spiniques dans la particule é partir des matrices d'Ising de chaque réplique. Cela correspond é l'énergie cinétique, sans prendre en compte J
 * @param p
